...
@section('content')
<section id="contact_us-top" class="top mb-3 mb-lg-5 p-0 d-flex align-items-center position-relative"
    aria-labelledby="contact_us-title">
    <div class="container">
        <!-- Content Section -->
        <div class="p-3 p-lg-5 text-center text-lg-start" role="region"
            aria-labelledby="contact_us-title contact_us-desc">
            <div class="content" data-aos="fade-up" data-aos-delay="0">
                <!-- Title -->
                <h1 id="contact_us-title" class="hero4 mb-4 fw-bold text-shadow">
                    Contact <u>us</u>
                </h1>
                <!-- Description -->
                <p id="contact_us-desc" class="text-lg mb-4 op-09 text-shadow">
                    Whether you're a potential partner, an investor, or a community member,
                    <br class="d-none d-lg-inline">don't hesitate to reach out.
                </p>
                ...
                <div class="d-flex flex-column flex-lg-row gap-5">
                    ...
                    <div class="text-center" data-aos="fade-up" data-aos-delay="50">
                        <button class="btn btn-primary btn-lg px-4"
                            ...
                            Start a conversation <i class="bi bi-chat-dots ms-2"></i>
                        </button>
                    </div>

                    <!-- Social Links -->
                    <div id="social-link"
                        class="nav-item d-flex gap-5 flex-lg-row gap-4 justify-content-center justify-content-lg-start align-items-center">
                        <!-- Telegram -->
                        <a href="https://t.me/ArchEthic_ENG" target="_blank" class="nav-link fs-3"
                            title="Join us on Telegram" aria-label="Join us on Telegram">
                            <i class="bi bi-telegram" aria-hidden="true"></i>
                        </a>
                        <!-- Discord -->
                        <a href="https://discord.com/invite/bZv9aHN7bd" target="_blank" class="nav-link fs-3"
                            title="Join us on Discord" aria-label="Join us on Discord">
                            <i class="bi bi-discord" aria-hidden="true"></i>
                        </a>
                        <!-- X (Twitter) -->
                        <a href="https://x.com/archethic" target="_blank" class="nav-link fs-3"
                            title="Follow us on X (formerly Twitter)" aria-label="Follow us on X (formerly Twitter)">
